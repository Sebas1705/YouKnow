...
class SignViewModel @Inject constructor(
    ...
    private fun signUpEmailAction(intent: SignIntent.SignUpWithEmail) = execute(Dispatchers.IO) {
        authUsesCases.signUpEmailUser(intent.nickname, intent.email, intent.password,
