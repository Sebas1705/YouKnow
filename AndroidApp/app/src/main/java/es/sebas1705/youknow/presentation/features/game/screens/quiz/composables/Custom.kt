package es.sebas1705.youknow.presentation.features.game.screens.quiz.composables
/*
...
fun Custom(
    ...
    var quizType by remember { mutableStateOf(QuizType.MULTIPLE) }
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.type) +
                        ": " + stringResource(quizType.strRes),
                color = MaterialTheme.colorScheme.onBackground,
                style = titleStyle
            )
            LazyRow(
            ...
            IVerSpacer(0.1f)
            IOutlinedButton(
                onClick = { onStartGame(difficulty, category, quizType, numQuestions) },
