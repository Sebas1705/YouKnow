            ...
            item {
                val data = mutableMapOf(
                    stringResource(id = R.string.feature_game_mode) to (stringResource(
                        wordPassState.mode?.strRes ?: es.sebas1705.core.resources.R.string.core_resources_any
                    )),
                    stringResource(id = es.sebas1705.core.resources.R.string.core_resources_points) + ":" to wordPassState.points.toReducedString(),
